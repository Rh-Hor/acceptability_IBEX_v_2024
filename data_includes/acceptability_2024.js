...
[["it7-pl-g", 7], aj, {s: {html: "<p><i>Kontext: Darek se zajímá o muly, což jsou často houževnatá zvířata. Tvrdí o nich:</i></p> Muly s tělesnou zdatností většinou nosívají těžký náklad."}}],
[["it7-pl-e", 7], aj, {s: {html: "<p><i>Kontext: Darek sledoval muly, z nichž některé dostaly velmi zabrat. Tvrdí o nich:</i></p> Muly s tělesnou zdatností právě unesly těžký náklad."}}],
[["it7-s-g", 7], aj, {s: {html: "<p><i>Kontext: Darek se zajímá o muly, což jsou často houževnatá zvířata. Tvrdí o nich:</i></p> Mula s tělesnou zdatností většinou nosívá těžký náklad."}}],
[["it7-s-e", 7], aj, {s: {html: "<p><i>Kontext: Darek sledoval muly, z nichž některé dostaly velmi zabrat. Tvrdí o nich:</i></p> Mula s tělesnou zdatností právě unesla těžký náklad."}}],
