...
[["it2-pl-e", 2], aj, {s: {html: "<p><i>Kontext: Jarka zkoumala zvířata, z nichž některá měla strach z petard. Tvrdí o nich:</i></p> Zvířata s dobrým sluchem právě uslyšela velký rámus."}}],
...
[["it2-s-e", 2], aj, {s: {html: "<p><i>Kontext: Jarka zkoumala zvířata, z nichž některá měla strach z petard. Tvrdí o nich:</i></p> Zvíře s dobrým sluchem právě uslyšelo velký rámus."}}],
...
[["it4-pl-e", 4], aj, {s: {html: "<p><i>Kontext: Magda sledovala autory, z nichž někteří píší špatné knihy. Tvrdí o nich:</i></p> Autoři s velkou arogancí právě napsali naprostý brak."}}],
...
[["it4-s-e", 4], aj, {s: {html: "<p><i>Kontext: Magda sledovala autory, z nichž někteří píší špatné knihy. Tvrdí o nich:</i></p> Autor s velkou arogancí právě napsal naprostý brak."}}],
...
[["it5-pl-e", 5], aj, {s:  {html: "<p><i>Kontext: Jana pozorovala děvčata, z nichž některá jedla odporná jídla. Tvrdí o nich:</i></p> Děvčata s výraznou podváhou právě snědla hnusné jídlo."}}],
...
[["it5-s-e", 5], aj, {s:  {html: "<p><i>Kontext: Jana pozorovala děvčata, z nichž některá jedla odporná jídla. Tvrdí o nich:</i></p> Děvče s výraznou podváhou právě snědlo hnusné jídlo."}}],
...
[["it6-pl-e", 6], aj, {s: {html: "<p><i>Kontext: Kuba zkoumal kočky, z nichž některé rády shazují věci. Tvrdí o nich:</i></p> Kočky s velkou hrdostí právě udělaly velký nepořádek."}}],
...
[["it6-s-e", 6], aj, {s:  {html: "<p><i>Kontext: Kuba zkoumal kočky, z nichž některé rády shazují věci. Tvrdí o nich:</i></p> Kočka s velkou hrdostí právě udělala velký nepořádek."}}],
...
[["it7-pl-e", 7], aj, {s: {html: "<p><i>Kontext: Jarek sledoval muly, z nichž některé dostávají velmi zabrat. Tvrdí o nich:</i></p> Muly s tělesnou zdatností právě unesly těžký náklad."}}],
...
[["it7-s-e", 7], aj, {s: {html: "<p><i>Kontext: Jarek sledoval muly, z nichž některé dostávají velmi zabrat. Tvrdí o nich:</i></p> Mula s tělesnou zdatností právě unesla těžký náklad."}}],
...
[["it11-pl-g", 11], aj, {s: {html: "<p><i>Kontext: Lenka se zajímá o ženy, což jsou často emocionální lidé. Tvrdí o nich:</i></p> Ženy s hlubokým citem většinou psávají dojemnou poezii."}}],
[["it11-pl-e", 11], aj, {s: {html: "<p><i>Kontext: Lenka zkoumala ženy, z nichž některé mají básnické střevo. Tvrdí o nich:</i></p> Ženy s hlubokým citem právě napsaly dojemnou poezii."}}],
[["it11-s-g", 11], aj, {s: {html: "<p><i>Kontext: Lenka se zajímá o ženy, což jsou často emocionální lidé. Tvrdí o nich:</i></p>Žena s hlubokým citem většinou psává dojemnou poezii."}}],
[["it11-s-e", 11], aj, {s: {html: "<p><i>Kontext: Lenka zkoumala ženy, z nichž některé mají básnické střevo. Tvrdí o nich:</i></p>Žena s hlubokým citem právě napsala dojemnou poezii."}}],

[["it12-pl-g", 12], aj, {s: {html: "<p><i>Kontext: Hanka se zajímá o ohaře, což jsou často lovečtí psi. Tvrdí o nich:</i></p> Ohaři s vrozenou agresivitou většinou nosívají zabitou kořist."}}],
[["it12-pl-e", 12], aj, {s:  {html: "<p><i>Kontext: Hanka sledovala ohaře, z nichž někteří umí dobře aportovat. Tvrdí o nich:</i></p> Ohaři s vrozenou agresivitou právě přinesli zabitou kořist."}}],
[["it12-s-g", 12], aj, {s:  {html: "<p><i>Kontext: Hanka se zajímá o ohaře, což jsou často lovečtí psi. Tvrdí o nich:</i></p> Ohař s vrozenou agresivitou většinou nosívá zabitou kořist."}}],
[["it12-s-e", 12], aj, {s:  {html: "<p><i>Kontext: Hanka sledovala ohaře, z nichž někteří umí dobře aportovat. Tvrdí o nich:</i></p> Ohař s vrozenou agresivitou právě přinesl zabitou kořist."}}],
...
[["it13-pl-e", 13], aj, {s: {html: "<p><i>Kontext: Pavel pozoroval lyžařky, z nichž některé jsou výbornými slalomistkami. Tvrdí o nich:</i></p> Lyžařky s letitou zkušeností právě zajely dobrý slalom."}}],
...
[["it13-s-e", 13], aj, {s: {html: "<p><i>Kontext: Pavel  pozoroval lyžařky, z nichž některé jsou výbornými slalomistkami. Tvrdí o nich:</i></p> Lyžařka s letitou zkušeností právě zajela dobrý slalom."}}],
