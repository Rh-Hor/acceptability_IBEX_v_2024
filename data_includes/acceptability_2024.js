...
[["it1-pl-g-nonpi", 1], aj, {s:{html: "<p><i>Kontext: Jarda se zajímá o koně, což jsou často energická zvířata. Tvrdí o nich:</i></p> Koně s dostatečnou energií většinou běhávají velkou vzdálenost."}}],
[["it1-pl-e-nonpi", 1], aj, {s:{html: "<p><i>Kontext: Jarda pozoroval koně, z nichž někteří utekli do města. Tvrdí o nich:</i></p> Koně s dostatečnou energií právě uběhli velkou vzdálenost."}}],
[["it1-s-g-nonpi", 1], aj, {s: {html: "<p><i>Kontext: Jarda se zajímá o koně, což jsou často energická zvířata. Tvrdí o nich:</i></p>Kůň s dostatečnou energií většinou běhává velkou vzdálenost."}}],
[["it1-s-e-nonpi", 1], aj, {s:{html: "<p><i>Kontext: Jarda pozoroval koně, z nichž někteří utekli do města. Tvrdí o nich:</i></p> Kůň s dostatečnou energií právě uběhl velkou vzdálenost."}}],
...
[["it2-pl-g-nonpi", 2], aj, {s:{html: "<p><i>Kontext: Jarka se zajímá o zvířata, což jsou často citliví tvorové. Tvrdí o nich:</i></p> Zvířata s dobrým sluchem většinou slýchávají velký rámus."}}],
[["it2-pl-e-nonpi", 2], aj, {s: {html: "<p><i>Kontext: Jarka zkoumala zvířata, z nichž některá projevila strach z petard. Tvrdí o nich:</i></p> Zvířata s dobrým sluchem právě uslyšela velký rámus."}}],
[["it2-s-g-nonpi", 2], aj, {s: {html: "<p><i>Kontext: Jarka se zajímá o zvířata, což jsou často citliví tvorové. Tvrdí o nich:</i></p> Zvíře s dobrým sluchem většinou slýchává velký rámus."}}],
[["it2-s-e-nonpi", 2], aj, {s: {html: "<p><i>Kontext: Jarka zkoumala zvířata, z nichž některá projevila strach z petard. Tvrdí o nich:</i></p> Zvíře s dobrým sluchem právě uslyšelo velký rámus."}}],
...
[["it3-pl-g-nonpi", 3], aj, {s: {html: "<p><i>Kontext: Zdeněk se zajímá o muslimy, což jsou často zbožní lidé. Tvrdí o nich:</i></p> Muslimové s pevnou vírou většinou chodívají tradiční pouť."}}],
[["it3-pl-e-nonpi", 3], aj, {s: {html: "<p><i>Kontext: Zdeněk vyzpovídal muslimy, z nichž někteří poznali město Mekku. Tvrdí o nich:</i></p> Muslimové s pevnou vírou právě ušli tradiční pouť."}}],
[["it3-s-g-nonpi", 3], aj, {s: {html: "<p><i>Kontext: Zdeněk se zajímá o muslimy, což jsou často zbožní lidé. Tvrdí o nich:</i></p> Muslim  s pevnou vírou většinou chodívá tradiční pouť."}}],
[["it3-s-e-nonpi", 3], aj, {s:  {html: "<p><i>Kontext: Zdeněk vyzpovídal muslimy, z nichž někteří poznali město Mekku. Tvrdí o nich:</i></p> Muslim s pevnou vírou právě ušel tradiční pouť."}}],
...
[["it4-pl-g-nonpi", 4], aj, {s: {html: "<p><i>Kontext: Magda se zajímá o autory, což jsou často namyšlení lidé. Tvrdí o nich:</i></p> Autoři s velkou arogancí většinou psávají naprostý brak."}}],
[["it4-pl-e-nonpi", 4], aj, {s: {html: "<p><i>Kontext: Magda sledovala autory, z nichž někteří odeslali nekvalitní texty. Tvrdí o nich:</i></p> Autoři s velkou arogancí právě napsali naprostý brak."}}],
[["it4-s-g-nonpi", 4], aj, {s: {html: "<p><i>Kontext: Magda se zajímá o autory, což jsou často namyšlení lidé. Tvrdí o nich:</i></p> Autor s velkou arogancí většinou psává naprostý brak."}}],
[["it4-s-e-nonpi", 4], aj, {s: {html: "<p><i>Kontext: Magda sledovala autory, z nichž někteří odeslali nekvalitní texty. Tvrdí o nich:</i></p> Autor s velkou arogancí právě napsal naprostý brak."}}],
...
[["it5-pl-g-nonpi", 5], aj, {s: {html: "<p><i>Kontext: Jana se zajímá o děvčata, což jsou často hubené děti. Tvrdí o nich:</i></p> Děvčata s výraznou podváhou většinou jídávají hnusné jídlo."}}],
[["it5-pl-e-nonpi", 5], aj, {s:  {html: "<p><i>Kontext: Jana pozorovala děvčata, z nichž některá snědla nevábná jídla. Tvrdí o nich:</i></p> Děvčata s výraznou podváhou právě snědla hnusné jídlo."}}],
[["it5-s-g-nonpi", 5], aj, {s:  {html: "<p><i>Kontext: Jana se zajímá o děvčata, což jsou často hubené děti. Tvrdí o nich:</i></p> Děvče s výraznou podváhou většinou jídává hnusné jídlo."}}],
[["it5-s-e-nonpi", 5], aj, {s:  {html: "<p><i>Kontext: Jana pozorovala děvčata, z nichž některá snědla nevábná jídla. Tvrdí o nich:</i></p> Děvče s výraznou podváhou právě snědlo hnusné jídlo."}}],
...
[["it6-pl-g-nonpi", 6], aj, {s: {html: "<p><i>Kontext: Kuba se zajímá o kočky, což jsou často pyšná zvířata. Tvrdí o nich:</i></p> Kočky s velkou hrdostí většinou dělávají velký nepořádek."}}],
[["it6-pl-e-nonpi", 6], aj, {s: {html: "<p><i>Kontext: Kuba zkoumal kočky, z nichž některé shodily všechny věci. Tvrdí o nich:</i></p> Kočky s velkou hrdostí právě udělaly velký nepořádek."}}],
[["it6-s-g-nonpi", 6], aj, {s: {html: "<p><i>Kontext: Kuba se zajímá o kočky, což jsou často pyšná zvířata. Tvrdí o nich:</i></p> Kočka s velkou hrdostí většinou dělává velký nepořádek."}}],
[["it6-s-e-nonpi", 6], aj, {s:  {html: "<p><i>Kontext: Kuba zkoumal kočky, z nichž některé rády shodily všechny věci. Tvrdí o nich:</i></p> Kočka s velkou hrdostí právě udělala velký nepořádek."}}],
...
[["it7-pl-g-nonpi", 7], aj, {s: {html: "<p><i>Kontext: Jarek se zajímá o muly, což jsou často houževnatá zvířata. Tvrdí o nich:</i></p> Muly s tělesnou zdatností většinou nosívají těžký náklad."}}],
[["it7-pl-e-nonpi", 7], aj, {s: {html: "<p><i>Kontext: Jarek sledoval muly, z nichž některé dostaly velmi zabrat. Tvrdí o nich:</i></p> Muly s tělesnou zdatností právě unesly těžký náklad."}}],
[["it7-s-g-nonpi", 7], aj, {s: {html: "<p><i>Kontext: Jarek se zajímá o muly, což jsou často houževnatá zvířata. Tvrdí o nich:</i></p> Mula s tělesnou zdatností většinou nosívá těžký náklad."}}],
[["it7-s-e-nonpi", 7], aj, {s: {html: "<p><i>Kontext: Jarek sledoval muly, z nichž některé dostaly velmi zabrat. Tvrdí o nich:</i></p> Mula s tělesnou zdatností právě unesla těžký náklad."}}],
[["it7-pl-g-npi", 7], aj, {s: {html: "<p><i>Kontext: Jarek se zajímá o muly, což jsou často houževnatá zvířata. Tvrdí o nich:</i></p> Muly se sebemenší trochou zdatnosti většinou nosívají těžký náklad."}}],
[["it7-pl-e-npi", 7], aj, {s: {html: "<p><i>Kontext: Jarek sledoval muly, z nichž některé dostaly velmi zabrat. Tvrdí o nich:</i></p> Muly se sebemenší trochou zdatnosti právě unesly těžký náklad."}}],
[["it7-s-g-npi", 7], aj, {s: {html: "<p><i>Kontext: Jarek se zajímá o muly, což jsou často houževnatá zvířata. Tvrdí o nich:</i></p> Mula se sebemenší trochou zdatnosti většinou nosívá těžký náklad."}}],
[["it7-s-e-npi", 7], aj, {s: {html: "<p><i>Kontext: Jarek sledoval muly, z nichž některé dostaly velmi zabrat. Tvrdí o nich:</i></p> Mula se sebemenší trochou zdatnosti právě unesla těžký náklad."}}],
	     
[["it8-pl-g-nonpi", 8], aj, {s: {html: "<p><i>Kontext: Jiřka se zajímá o jasnovidky, což jsou často mystické ženy. Tvrdí o nich:</i></p> Jasnovidky s magickým nadáním většinou vídávají smutnou budoucnost."}}],
[["it8-pl-e-nonpi", 8], aj, {s: {html: "<p><i>Kontext: Jiřka vyzpovídala jasnovidky, z nichž některé vyvěštily samé trápení. Tvrdí o nich:</i></p> Jasnovidky s magickým nadáním právě uviděly smutnou budoucnost."}}],
[["it8-s-g-nonpi", 8], aj, {s: {html: "<p><i>Kontext: Jiřka se zajímá o jasnovidky, což jsou často mystické ženy. Tvrdí o nich:</i></p> Jasnovidka s magickým nadáním většinou vídává smutnou budoucnost."}}],
[["it8-s-e-nonpi", 8], aj, {s: {html: "<p><i>Kontext: Jiřka vyzpovídala  jasnovidky, z nichž některé vyvěštily samé trápení. Tvrdí o nich:</i></p> Jasnovidka s magickým nadáním právě uviděla smutnou budoucnost."}}],
...
[["it9-pl-g-nonpi", 9], aj, {s: {html: "<p><i>Kontext: Zdena se zajímá o děti, což jsou často nenasytní tvorové. Tvrdí o nich:</i></p> Děti s nezkrotnou mlsností většinou jídávají prošlé cukroví."}}],
[["it9-pl-e-nonpi", 9], aj, {s: {html: "<p><i>Kontext: Zdena pozorovala děti, z nichž některým nevadí staré potraviny. Tvrdí o nich:</i></p> Děti s nezkrotnou mlsností právě snědly prošlé cukroví."}}],
[["it9-s-g-nonpi", 9], aj, {s: {html: "<p><i>Kontext: Zdena se zajímá o děti, což jsou často nenasytní tvorové. Tvrdí o nich:</i></p> Dítě  s nezkrotnou mlsností většinou jídává prošlé cukroví."}}],
[["it9-s-e-nonpi", 9], aj, {s: {html: "<p><i>Kontext: Zdena pozorovala děti, z nichž některým nevadí staré potraviny. Tvrdí o nich:</i></p> Dítě s nezkrotnou mlsností právě snědlo prošlé cukroví."}}],
...
[["it10-pl-g-nonpi", 10], aj, {s: {html: "<p><i>Kontext: David se zajímá o kritiky, což jsou často přísní lidé. Tvrdí o nich:</i></p> Kritici s vytříbeným vkusem většinou slýchávají špatnou hudbu."}}],
[["it10-pl-e-nonpi", 10], aj, {s: {html: "<p><i>Kontext: David vyzpovídal kritiky, z nichž někteří vnímali koncert negativně. Tvrdí o nich:</i></p> Kritici s vytříbeným vkusem právě uslyšeli špatnou hudbu."}}],
[["it10-s-g-nonpi", 10], aj, {s: {html: "<p><i>Kontext: David se zajímá o kritiky, což jsou často přísní lidé. Tvrdí o nich:</i></p> Kritik s vytříbeným vkusem většinou slýchává špatnou hudbu."}}],
[["it10-s-e-nonpi", 10], aj, {s: {html: "<p><i>Kontext: David vyzpovídal kritiky, z nichž někteří vnímali koncert negativně. Tvrdí o nich:</i></p> Kritik s vytříbeným vkusem právě uslyšel špatnou hudbu."}}],
...
[["it11-pl-g-nonpi", 11], aj, {s: {html: "<p><i>Kontext: Lenka se zajímá o básnířky, což jsou často emocionální ženy. Tvrdí o nich:</i></p> Ženy s hlubokým citem většinou psávají dojemnou poezii."}}],
[["it11-pl-e-nonpi", 11], aj, {s: {html: "<p><i>Kontext: Lenka zkoumala básnířky, z nichž některé stvořily úžasné básně. Tvrdí o nich:</i></p> Ženy s hlubokým citem právě napsaly dojemnou poezii."}}],
[["it11-s-g-nonpi", 11], aj, {s: {html: "<p><i>Kontext: Lenka se zajímá o básnířky, což jsou často emocionální ženy. Tvrdí o nich:</i></p>Žena s hlubokým citem většinou psává dojemnou poezii."}}],
[["it11-s-e-nonpi", 11], aj, {s: {html: "<p><i>Kontext: Lenka zkoumala básnířky, z nichž některé stvořily úžasné básně. Tvrdí o nich:</i></p>Žena s hlubokým citem právě napsala dojemnou poezii."}}],
[["it11-pl-g-npi", 11], aj, {s: {html: "<p><i>Kontext: Lenka se zajímá o básnířky, což jsou často emocionální ženy. Tvrdí o nich:</i></p> Ženy se sebemenším náznakem citu většinou psávají dojemnou poezii."}}],
[["it11-pl-e-npi", 11], aj, {s: {html: "<p><i>Kontext: Lenka zkoumala básnířky, z nichž některé stvořily úžasné básně. Tvrdí o nich:</i></p> Ženy se sebemenším náznakem citu právě napsaly dojemnou poezii."}}],
[["it11-s-g-npi", 11], aj, {s: {html: "<p><i>Kontext: Lenka se zajímá o básnířky, což jsou často emocionální ženy. Tvrdí o nich:</i></p>Žena se sebemenším náznakem citu většinou psává dojemnou poezii."}}],
[["it11-s-e-npi", 11], aj, {s: {html: "<p><i>Kontext: Lenka zkoumala básnířky, z nichž některé stvořily úžasné básně. Tvrdí o nich:</i></p>Žena se sebemenším náznakem citu právě napsala dojemnou poezii."}}],

[["it12-pl-g-nonpi", 12], aj, {s: {html: "<p><i>Kontext: Hanka se zajímá o ohaře, což jsou často temperamentní psi. Tvrdí o nich:</i></p> Ohaři s vrozenou agresivitou většinou nosívají zabitou kořist."}}],
[["it12-pl-e-nonpi", 12], aj, {s:  {html: "<p><i>Kontext: Hanka sledovala ohaře, z nichž někteří zvládli dobře aportovat. Tvrdí o nich:</i></p> Ohaři s vrozenou agresivitou právě přinesli zabitou kořist."}}],
[["it12-s-g-nonpi", 12], aj, {s:  {html: "<p><i>Kontext: Hanka se zajímá o ohaře, což jsou často temperamentní psi. Tvrdí o nich:</i></p> Ohař s vrozenou agresivitou většinou nosívá zabitou kořist."}}],
[["it12-s-e-nonpi", 12], aj, {s:  {html: "<p><i>Kontext: Hanka sledovala ohaře, z nichž někteří zvládli dobře aportovat. Tvrdí o nich:</i></p> Ohař s vrozenou agresivitou právě přinesl zabitou kořist."}}],
...
[["it13-pl-g-nonpi", 13], aj, {s: {html: "<p><i>Kontext: Pavel se zajímá o lyžařky, což jsou často ostřílené sportovkyně. Tvrdí o nich:</i></p> Lyžařky s letitou zkušeností většinou jezdívají dobrý slalom."}}],
[["it13-pl-e-nonpi", 13], aj, {s: {html: "<p><i>Kontext: Pavel pozoroval lyžařky, z nichž některé podaly úžasný výkon. Tvrdí o nich:</i></p> Lyžařky s letitou zkušeností právě zajely dobrý slalom."}}],
[["it13-s-g-nonpi", 13], aj, {s: {html: "<p><i>Kontext: Pavel se zajímá o lyžařky, což jsou často ostřílené sportovkyně. Tvrdí o nich:</i></p> Lyžařka s letitou zkušeností většinou jezdívá dobrý slalom."}}],
[["it13-s-e-nonpi", 13], aj, {s: {html: "<p><i>Kontext: Pavel  pozoroval lyžařky, z nichž některé podaly úžasný výkon. Tvrdí o nich:</i></p> Lyžařka s letitou zkušeností právě zajela dobrý slalom."}}],
...
[["it14-pl-g-nonpi", 14], aj, {s: {html: "<p><i>Kontext: Marek se zajímá o herečky, což jsou často nadané umělkyně. Tvrdí o nich:</i></p> Herečky s přirozeným talentem většinou hrávají působivé drama."}}],
[["it14-pl-e-nonpi", 14], aj, {s: {html: "<p><i>Kontext: Marek sledoval herečky, z nichž některé dojaly každého diváka. Tvrdí o nich:</i></p> Herečky s přirozeným talentem právě sehrály působivé drama."}}],
[["it14-s-g-nonpi", 14], aj, {s: {html: "<p><i>Kontext: Marek se zajímá o herečky, což jsou často nadané umělkyně. Tvrdí o nich:</i></p> Herečka s přirozeným talentem většinou hrává působivé drama."}}],
[["it14-s-e-nonpi", 14], aj, {s: {html: "<p><i>Kontext: Marek sledoval herečky, z nichž některé dojaly každého diváka. Tvrdí o nich:</i></p> Herečka s přirozeným talentem právě sehrála působivé drama."}}],
...
[["it15-pl-g-nonpi", 15], aj, {s: {html: "<p><i>Kontext: Zora se zajímá o vědce, což jsou často rozumní lidé. Tvrdí o nich:</i></p> Vědci s opravdovou snahou většinou dělávají kvalitní práci."}}],
[["it15-pl-e-nonpi", 15], aj, {s: {html: "<p><i>Kontext: Zora zkoumala vědce, z nichž někteří vyvinuli špičkové metody. Tvrdí o nich:</i></p> Vědci s opravdovou snahou právě udělali kvalitní práci."}}],
[["it15-s-g-nonpi", 15], aj, {s: {html: "<p><i>Kontext: Zora se zajímá o vědce, což jsou často rozumní lidé. Tvrdí o nich:</i></p> Vědec s opravdovou snahou většinou dělává kvalitní práci."}}],
[["it15-s-e-nonpi", 15], aj, {s: {html: "<p><i>Kontext: Zora zkoumala vědce, z nichž někteří vyvinuli špičkové metody. Tvrdí o nich:</i></p> Vědec s opravdovou snahou právě udělal kvalitní práci."}}],
...
[["it16-pl-g-nonpi", 16], aj, {s: {html: "<p><i>Kontext: Pepa se zajímá o běžce, což jsou často vytrvalí lidé. Tvrdí o nich:</i></p> Běžci s pořádnou disciplínou většinou běhávají dobrý maraton."}}],
[["it16-pl-e-nonpi", 16], aj, {s: {html: "<p><i>Kontext: Pepa pozoroval běžce, z nichž někteří doběhli závod brzy. Tvrdí o nich:</i></p> Běžci s pořádnou disciplínou právě zaběhli dobrý maraton."}}],
[["it16-s-g-nonpi", 16], aj, {s: {html: "<p><i>Kontext: Pepa se zajímá o běžce, což jsou často vytrvalí lidé. Tvrdí o nich:</i></p> Běžec s pořádnou disciplínou většinou běhává dobrý maraton."}}],
[["it16-s-e-nonpi", 16], aj, {s: {html: "<p><i>Kontext: Pepa pozoroval běžce, z nichž někteří doběhli závod brzy. Tvrdí o nich:</i></p> Běžec s pořádnou disciplínou právě zaběhl dobrý maraton."}}],
